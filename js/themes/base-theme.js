...
export default {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: (Platform.OS === 'ios') ? '#F8F8F8' : '#8D6437',


  // FooterTab
  tabBarTextColor: (Platform.OS === 'ios') ? '#6b6b6b' : '#b3c7f9',
  tabBarActiveTextColor: (Platform.OS === 'ios') ? '#8D6437' : '#fff',
  tabActiveBgColor: (Platform.OS === 'ios') ? '#e4f0fe' : undefined,


  // Header
  iosToolbarBtnColor: '#8D6437',
  toolbarDefaultBg: (Platform.OS === 'ios') ? '#F8F8F8' : '#8D6437',
